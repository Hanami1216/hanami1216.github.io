...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="选择框状态" tabindex="-1"><a class="header-anchor" href="#选择框状态" aria-hidden="true">#</a> 选择框状态</h3>`,37),v={href:"https://www.cnblogs.com/jimloveq/p/10602060.html",target:"_blank",rel:"noopener noreferrer"},m=i(`<div class="language-JavaScript line-numbers-mode" data-ext="JavaScript"><pre class="language-JavaScript"><code>//取消导航项的 checked，同类名称都会取消 checked 状态
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12);function b(k,h){const s=u("ExternalLinkIcon");return l(),c("div",null,[a("p",null,[n("JavaScript 是一种具有函数优先的轻量级，解释型或即时编译型的编程语言，最新标准是 "),a("a",d,[n("ECMAScript 6.0"),e(s)]),n("。虽然它是作为开发 Web 页面的脚本语言而出名，但是它也被用到了很多非浏览器环境中，并长年居于最受欢迎编程语言排行榜榜首。")]),a("p",null,[n("推荐学习流程：「JavaScript」>「ES6」>「"),a("a",o,[n("TypeScript"),e(s)]),n("」。")]),p,a("p",null,[n("调用 attr 给选择框 radio、checkbox 添加 checked 属性和移调，并不能真实改变不能单选和选中框的真实状态，可用下方代码改变。^["),a("a",v,[n("radio、checkbox 选中状态研究"),e(s)]),n("]")]),m])}const g=t(r,[["render",b],["__file","Javascript.html.vue"]]);export{g as default};
